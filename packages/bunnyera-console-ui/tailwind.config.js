...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // BunnyEra 主色调 - 蓝紫渐变风格 (Microsoft 365 Copilot 风格)
        be: {
          primary: 'var(--be-primary)',
          'primary-hover': 'var(--be-primary-hover)',
          'primary-light': 'var(--be-primary-light)',
          accent: 'var(--be-accent)',
          'accent-hover': 'var(--be-accent-hover)',
        ...
        // 中性色
        surface: {
          DEFAULT: 'var(--be-surface)',
          elevated: 'var(--be-surface-elevated)',
          overlay: 'var(--be-surface-overlay)',
        },
        // 文字颜色
        text: {
          primary: 'var(--be-text-primary)',
          secondary: 'var(--be-text-secondary)',
          tertiary: 'var(--be-text-tertiary)',
